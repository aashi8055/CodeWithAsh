...
public static void main1() {
	...
	System.out.println(fibonacciSearch(first, 7, 8));
...
public static boolean findPairTwoLists3(int[] arr1, int size1, int[] arr2, int size2, int value) {
...
public static boolean findPairTwoLists4(int[] arr1, int size1, int[] arr2, int size2, int value) {
	HashSet<Integer> hs = new HashSet<Integer>();
...
public static boolean findPairTwoLists5(int[] arr1, int size1, int[] arr2, int size2, int range, int value) {
	int[] count = new int[range + 1];
	Arrays.fill(count, 0);
...
public static void main38() {
	...
	System.out.println(checkPermutation2(str1, str1.length, str2, str2.length));
	System.out.println(checkPermutation3(str1, str1.length, str2, str2.length));
}
/*
 * true
 * true
...
public static void main41() {
	int[] arr = { 2, 4, 8, 16 };
	System.out.println("Floor :  " + findFloor(arr, arr.length, 5));
	System.out.println("Ceil :  " + findCeil(arr, arr.length, 5));
}
/*
Floor :  4
Ceil :  8
...
/*
 * def ksmallest_elements(arrIn, k): size = len(arrIn) arr = list(arrIn)
 * arr.sort() for i in range(size): if arrIn[i] <= arr[k-1]: print(arrIn[i],
 * end=' ')
 * 
 * def ksmallest_elements2(arrIn, k): size = len(arrIn) arr = list(arrIn)
 * quick_select_util(arr, 0, size-1, k) for i in range(size): if arrIn[i] <=
 * arr[k-1]: print(arrIn[i], end=' ')
 * 
 * def main38(): arr = [4, 2, 6, 1, 5] ksmallest_elements(arr, 3) print("")
 * ksmallest_elements2(arr, 3) print("") arr = [ 1, 5, 8, 9, 6, 7, 3, 4, 2, 0]
 * ksmallest_elements(arr, 5) print("") ksmallest_elements2(arr, 5) print("")
 * 
 */
...
public static void subArraySums(int arr[], int size, int value) {
	...
	while (start < size && end < size) {
		...
		if (sum == value) {
			System.out.print("(" + start + " to " + (end - 1) + ") ");
		}
	}
}
